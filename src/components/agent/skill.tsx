export function Accounting() {
  return (
    <div className="flex grow font-jost">
      <div className="flex w-full items-center gap-1.5 px-2 py-1 outline-1 outline-slate-500 print:outline-slate-950">
        <span
      ...
      <div className="w-20 p-1 outline-1 outline-slate-500 print:outline-slate-950">
        <div
...
export function Art() {
  return (
    <div className="flex grow font-jost">
      <div className="flex w-full flex-col gap-1.5 px-2 py-1 outline-1 outline-slate-500 print:gap-0 print:outline-slate-950">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="grow" data-headlessui-state="">
            ...
            <input
              className="min-h-10 w-full justify-self-end rounded-t-md border-b border-slate-500 bg-zinc-300 bg-opacity-70 px-2 py-0.5 hover:bg-opacity-100 focus-visible:border-b-0 focus-visible:bg-opacity-100 focus-visible:outline-2 focus-visible:outline-slate-600 sm:min-h-0 sm:px-1 print:border-0 print:bg-transparent print:p-0 print:text-xs"
              maxLength={50}
              placeholder=""
      ...
      <div className="flex w-20 flex-col gap-1.5 p-1 pt-[3.125rem] outline-1 outline-slate-500 sm:pt-8 print:gap-0 print:pt-6 print:outline-slate-950">
