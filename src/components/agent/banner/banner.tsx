...
import DeltaGreenLogo from "./deltagreen_cutout_k.webp";
    ...
    <div className="flex bg-black dark:bg-white h-12">
      <div className="grid grid-cols-3 w-full px-2">
        ...
        <div className="flex justify-center">
          ...
          <Link href="/" className="hidden md:inline print:inline">
            <Image
              priority={true}
              src={KappaBlackCutoutW}
              alt="Kappa Black logo"
              height="48"
              className="bg-black hidden dark:inline print:hidden"
            />
            <Image
              priority={true}
              src={KappaBlackCutoutK}
              alt="Kappa Black logo"
              height="48"
              className="bg-white inline dark:hidden print:hidden"
            />
            <Image
              priority={true}
              src={DeltaGreenLogo}
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <DarkModeToggle className="cursor-pointer bg-black text-zinc-200 border-zinc-800 hover:text-white hover:bg-zinc-800 hover:border-zinc-600 dark:text-black dark:border-zinc-100 dark:hover:bg-zinc-200 dark:hover:text-black dark:hover:border-zinc-200 print:hidden" />
        </div>
      </div>
    </div>
  );
